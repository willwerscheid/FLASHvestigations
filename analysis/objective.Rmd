...
More seriously, the sawtooth pattern depicted above points to a more regular feature of the optimization. Indeed, it appears that all of the triangles (objectives after updating factors) are biased upwards and, perhaps, all of the squares (objectives after updating loadings) are biased slightly downwards. 
