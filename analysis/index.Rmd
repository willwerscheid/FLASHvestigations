...
The suggestions outlined in Note 4 were implemented in version X.X-X of `flashr`.

* [Note 4.](matrix_ops.html) Outlines several ways to modify the core FLASH algorithms in view of reducing the memory footprint and improving overall performance. 
