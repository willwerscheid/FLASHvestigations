...
Investigations 19 and 20 try FLASH out on large single-cell RNA datasets.

* [Investigation 19.](trachea.html) An analysis of the smaller dataset in [Montoro et al.](https://www.nature.com/articles/s41586-018-0393-7)

* [Investigation 20.](pulseseq.html) An analysis of the larger "pulse-seq" dataset in Montoro et al.

[Note 4.](matrix_ops.html) I have been experiencing some performance issues when using FLASH to fit large datasets. Here I outline several ways to modify the core FLASH algorithms in view of reducing the memory footprint and improving overall performance. 
