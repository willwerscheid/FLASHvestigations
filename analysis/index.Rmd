...
[Note 3.](matrix_ops.html) I have been experiencing some performance issues when using FLASH to fit large datasets. Here I outline an idea for reducing the memory footprint. 
