...
* [Investigation 17.](binary_data.html) Using an approach that is similar to that of the previous analysis, I fit binary data via an approximation to the binomial log likelihood.
