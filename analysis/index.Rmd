...
[Investigation 13.](nonnegative.html) I use nonnegative priors to obtain a factorization of the GTEx donation matrix. Loadings are not substantially different from those obtained using `NNLM`.
