...
[Note 4.](matrix_ops.html) I have been experiencing some performance issues when using FLASH to fit large datasets. Here I outline several ideas for reducing the memory footprint and improving overall performance. 
