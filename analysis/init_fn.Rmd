---
title: "Effect of init_fn on speed and objective"
...
The improvement in the objective function per factor is as follows. (Again, I suppress results for `udv_si_svd` because they are identical to `udv_svd`.) 
